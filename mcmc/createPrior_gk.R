...
#### Only thing changes is to give names if do multiple samples

createPrior_gk <- function(density = NULL, sampler = NULL, lower = NULL, upper = NULL, best = NULL){
